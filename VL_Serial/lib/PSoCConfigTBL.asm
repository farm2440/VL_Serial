...
export LoadConfigTBL_vl_serial_Bank1
export LoadConfigTBL_vl_serial_Bank0
export LoadConfigTBL_vl_serial_Ordered
AREA lit(rom, rel)
LoadConfigTBL_vl_serial_Bank0:
...
;       Instance name UART, Block Name TX(DCB02)
	...
	db		2ah, 44h		;UART_TX_OUTPUT_REG (DCB02OU)
...
LoadConfigTBL_vl_serial_Ordered:
