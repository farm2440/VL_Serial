...
export LoadConfig_vl_serial
export _LoadConfig_vl_serial
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_vl_serial
	lcall	LoadConfigTBL_vl_serial_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration vl_serial
;
;    Load configuration registers for vl_serial.
...
;               CUR_PP
;
_LoadConfig_vl_serial:
 LoadConfig_vl_serial:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_vl_serial_Bank0
    mov     X, <LoadConfigTBL_vl_serial_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_vl_serial_Bank1
    mov     X, <LoadConfigTBL_vl_serial_Bank1
